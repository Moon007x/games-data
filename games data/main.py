...
plt.scatter(df_main["first_release_date"], df_main["critic_rating_value"], color = "blue", lable = "Critic Ratings")

plt.scatter(df_main["first_release_date"], df_main["user_rating_value"], color = "red", lable = "User Rating")
...
plt.bar(df_follow.index - BAR_WIDTH / 2, df_follow["total_follows"], color = "blue", lable = "number of Follows", width = BAR_WIDTH)

plt.bar(df_hype.index + BAR_WIDTH / 2, df_hype["total_hypes"], color = "red", lable = "Number of Hypes", width = BAR_WIDTH)
